package niram.artmaterials.niramcanvas

import android.app.Application
//[ANY][import_PrepRepository]
import niram.artmaterials.niramcanvas.di.dataModule
import niram.artmaterials.niramcanvas.di.dispatcherModule
import niram.artmaterials.niramcanvas.di.viewModule
...
class IWURVApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@IWURVApplication)
            modules(appModules)
        }
