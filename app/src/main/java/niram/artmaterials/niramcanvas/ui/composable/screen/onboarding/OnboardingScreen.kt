...
private val onboardingPagesContent = listOf<OnboardingContent>(
    OnboardingContent(
        titleRes = R.string.iwurv_page_1_title,
        descriptionRes = R.string.iwurv_page_1_description,
        imageRes = R.drawable.iwurv_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.iwurv_page_2_title,
        descriptionRes = R.string.iwurv_page_2_description,
        imageRes = R.drawable.iwurv_ic_launcher_background,
    ),
    OnboardingContent(
        titleRes = R.string.iwurv_page_2_title,
        descriptionRes = R.string.iwurv_page_3_description,
        imageRes = R.drawable.iwurv_ic_launcher_background,
    ),
)
